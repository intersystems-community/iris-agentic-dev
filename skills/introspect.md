---
name: introspect
description: Fetch a class definition from IRIS via Atelier REST and summarize its API for use in coding tasks.
args:
  - name: class_name
    description: "Fully-qualified class name (e.g. MyPackage.MyClass or EnsLib.HTTP.OutboundAdapter)"
---
