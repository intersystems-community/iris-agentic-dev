...
- **objectscript-navigation** — to map the full dependency graph before planning repairs
- **objectscript-debugging** — to trace runtime errors to their source before repairing
- **objectscript-review** — to review the repaired code before compiling
- **objectscript-tdd** — to write a failing test first, then repair until it passes
